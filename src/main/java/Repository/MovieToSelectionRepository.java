...
public class MovieToSelectionRepository {
   ...
   private static String DELETE_BY_SELECTION_ID = "DELETE FROM movie_selection WHERE selection_id=?";
    ...
    public static List<MovieToSelection> findByMovieId(int movieId) {
    ...
    public static List<MovieToSelection> findBySelectionId(int selectionId) {
        List<MovieToSelection> movieToSelections = new ArrayList<>();
        try(Connection connection = DBUtil.getConnection();
    ...
    public static void addMovieToSelection(MovieToSelection movieToSelection) {
        try(Connection connection = DBUtil.getConnection();
    ...
    public static void deleteByMovieId(int movieId) {
        try(Connection connection = DBUtil.getConnection();
    ...
    public static void deleteBySelectionId(int selectionId) {
        try(Connection connection = DBUtil.getConnection();
